...
export default function RidePlanScreen() {
  ...
  const initializeWebSocket = () => {
    ws.current = new WebSocket("ws://192.168.43.162:8080");
    ws.current.onopen = () => {
  ...
  const handleOrder = async () => {
    ...
    // check terminal of driver and put token
    const driverPushToken = "ExponentPushToken[puT_UPNtTWsL8RQqbZzjkg]";
                          ...
                          <Image
                            source={
                              driver?.vehicle_type === "Car"
                                ? require("@/assets/images/vehicles/taxi2.png")
                                : driver?.vehicle_type === "Motocycle"
                                ? require("@/assets/images/vehicles/bike.png")
                                : driver?.vehicle_type === "cng"
                                ? require("@/assets/images/vehicles/kekeh.png")
                                : require("@/assets/images/vehicles/taxi.png") //Fallback
                        ...
                        >
                          <View>
                            <Text style={{ fontSize: 20, fontWeight: "600" }}>
                              RideSalone {driver?.vehicle_type}
                            </Text>
