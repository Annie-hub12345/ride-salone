...
export default function HomeScreen() {
  ...
  const ws = new WebSocket("ws://192.168.43.162:8080");
  ...
  const acceptRideHandler = async () => {
    ...
    await axios
      ...
      .then(async (res) => {
        ...
        // check terminal of user and put token
        const driverPushToken = "ExponentPushToken[do7c74NLALW4DB3GEiwHsE]";
        ...
        <TouchableOpacity style={styles.modalBackground} activeOpacity={1}>
          <TouchableOpacity style={styles.modalContainer} activeOpacity={1}>
            <View>
              ...
              >
                Amount:
                {(distance * parseInt(driver?.rate!)).toFixed(2)} NLe
              </Text>
              <View
                style={{
                  flexDirection: "row",
